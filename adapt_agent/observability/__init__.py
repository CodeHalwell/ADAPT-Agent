...
class AgentObserver:
    ...
    def __init__(self):
        ...
        # ⚡ Bolt Optimization: Using a dictionary keyed by trace_id instead of a list
        # changes lookups in end_trace and log_event from O(n) to O(1), significantly
        # improving performance as the number of traces grows.
