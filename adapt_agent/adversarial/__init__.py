...
class AdversarialDefense:
    ...
    def __init__(self, max_attacks: int = 1000, max_content_length: Optional[int] = None):
        ...
        Args:
            ...
            max_content_length: Optional maximum allowed length for input content. If set, any content exceeding this length will be blocked (DoS protection).
        """
    ...
    def analyze_input(self, input_text: str) -> dict[str, Any]:
        ...
        # SECURITY: DoS protection by limiting input length before processing
        if self.max_content_length is not None and len(input_text) > self.max_content_length:
            self._record_attack("dos_attack", input_text, "content_length_exceeded")
