...
class Middleware:
    ...
    def process_input(self, data: dict[str, Any], copy: bool = True) -> dict[str, Any]:
        ...
        Args:
            ...
            copy: Whether to copy the input data before processing (default: True)
        ...
        # ⚡ Bolt: Only copy data if requested, bypassing redundant allocations when called internally with freshly constructed dictionaries
    ...
    def process_output(self, data: dict[str, Any], copy: bool = True) -> dict[str, Any]:
        ...
        Args:
            ...
            copy: Whether to copy the output data before processing (default: True)
    ...
    def wrap_function(self, func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            # Pre-process
            # ⚡ Bolt: Pass copy=False since input_data was just created here
            ...
            # ⚡ Bolt: Pass copy=False since output_data was just created here
