...
class Middleware:
    ...
    def process_input(self, data: dict[str, Any], copy: bool = True) -> dict[str, Any]:
        ...
        Args:
            ...
            copy: Whether to copy the input dict
        ...
        # ⚡ Bolt: Allow bypassing redundant data.copy() allocations for locally constructed ephemeral objects
    ...
    def wrap_function(self, func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            ...
            # Pre-process
            # ⚡ Bolt: Pass copy=False since input_data is a locally constructed ephemeral dictionary
            ...
            # ⚡ Bolt: Pass copy=False since output_data is a locally constructed ephemeral dictionary
