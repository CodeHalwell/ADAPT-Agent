...
## 2024-05-24 - O(N) bottlenecks in cache eviction
**Learning:** Maintaining a bounded cache limit by continuously recalculating the total item count inside an eviction loop creates an O(N) bottleneck.
